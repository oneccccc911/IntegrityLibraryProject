...
<script>
	...
	function call_book() {
		...
		location.href = "bookTitle2?book_name=" + name;
	}
</script>
</head>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">
						<i class="fa fa-money fa-fw"></i> 검색 결과
					</h3>
				</div>
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<tbody>
								<c:forEach items="${booklist }" var="book">
									<tr>
										<td>${book.book_ID}</td>
										<td><a href="bookDetail2?book_ID=${book.book_ID}
										">${book.book_name}</a></td>
