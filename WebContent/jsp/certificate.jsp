...
<head>
    ...
    <script>
    	window.onload=function(){	 
			...
			if(msg==1){
				alert("소속되어 있지 않습니다.");
				document.getElementById("univ_num").focus();
			}
			else if(msg==2){
...
<!-- 마페&manageuser /끝 -->
        ...
        <div id="page-wrapper">
			<br><br><br><br><br>
			<div class="container" style="padding:80px 10px 320px 10px">
			  <form class="form-horizontal" action="certificate" method="post">
			    <div class="form-group">
			      <h2 style="font-size:300%;">인증 절차</h2><br><br><br><br><br><br>
			      <input type="hidden"   id="msg"  value="${msg }">
			      <label class="control-label col-sm-2">학번:</label>
			      <div class="col-sm-5">
			        <input type="text" class="form-control" id="email" placeholder="학번 입력" name="univ_num">
			      </div>
			    </div>
			    <div class="form-group">
			      <label class="control-label col-sm-2">학교이름:</label>
			      <div class="col-sm-5">          
			        <input type="text" class="form-control" id="pwd" placeholder="학교 입력" name="univ_name" >
			      </div>
			    </div>
			    <div class="form-group">        
