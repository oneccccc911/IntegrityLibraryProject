...
<head>
	...
	<script>
	function call_reserve(reserve_num, book_ID, copy_ID, user_ID){
		var result = confirm("예약을 취소하시겠습니까?");
		if(result){
			//alert(user_ID);
			//alert(reserve_num+book_ID+copy_ID+user_ID);
			location.href="reserveDelete?reserve_num="+reserve_num+"&"+"book_ID="+book_ID+"&"+"copy_ID="+copy_ID;
		}
	}
	</script>
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="Mypage"><i class="fa fa-fw fa-user"></i> My Page</a>
                        </li>
		...
		<br><br><br><br><br>
			<div class="panel panel-default">
               <div class="panel-heading">
                   <h3 class="panel-title" style="font-size:200%; text-align: center"><i class="fa fa-fw fa-edit"></i> 예약 리스트 조회</h3>
               </div>
               <div class="panel-body">
                   <div class="table-responsive">
                       <table class="table table-bordered table-hover table-striped">
                           ...
                           <tbody>
                               <c:forEach items="${inquireList }" var="reserve">
									<tr>
										<td>${reserve.reserve_num }</td>
										<td>${reserve.wait_num }</td>
										<td>${reserve.book_name }</td>
										<td>${reserve.book_ID }</td>
										<td>${reserve.copy_ID }</td>
										
										<c:if test="${user_ID != 'admin'}">	
										<td>
										<button onclick='call_reserve(${reserve.reserve_num},"${reserve.book_ID}","${reserve.copy_ID}","${user_ID }")' 
