...
<!-- 스미스드롭박스 /끝 -->
 ...
 <!-- 마페&manageuser /시작 -->	 
                    ...
                    <li>
                    <a href="UserList" ><i class="fa fa-fw fa-user"></i> Manage Users</a>
                    </li>
                    </c:if>
<!-- 마페&manageuser /끝 -->
                    <li>
         ...
         <div class="container" style="padding:40px 10px 70px 10px">
           <div class="form-horizontal">
              <form action="MyPage" method="post">
                  ...
                  <h2 style="font-size:300%;">${user.user_ID }님의 정보</h2><br><br><br><br><br>
                  
                <div class="form-group">
                  <label class="control-label col-sm-2">ID :</label>
                  <div class="col-sm-5">          
                    <input type="text" class="form-control" id="user_ID" name="user_ID" 
                    value="${user.user_ID }" readonly="readonly" style="background-color:lightgray">                                
                  </div>              
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-5">          
                    ...
                    placeholder="Password 입력" name="user_pass" value="${user.user_pass }" ><br>                    
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-5">          
                    ...
                    placeholder="이름 입력" name="user_name" value="${user.user_name }" ><br>                    
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-5">          
                    ...
                    placeholder="주소 입력" name="user_addr" value="${user.user_addr }" ><br>                    
                  </div>
                </div>
                  <div class="form-group">
                  ...
                  <div class="col-sm-5">          
                    ...
                    placeholder="전화번호 입력" name="user_tel" value="${user.user_tel }" ><br>                    
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">학교 :</label>
                  <div class="col-sm-5">          
                    <input type="text" class="form-control" id="univ_name" readonly="readonly" style="background-color:lightgray"
                     name="univ_name" value="${user.univ_name }" ><br>                    
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">등급 :</label>
                  <div class="col-sm-5">          
                    <input type="text" class="form-control" id="grade" readonly="readonly" style="background-color:lightgray"
                     name="grade" value="${user.grade }" ><br>                    
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">학번 :</label>
                  <div class="col-sm-5">          
                    <input type="text" class="form-control" id="univ_num" readonly="readonly" style="background-color:lightgray"
                     name="univ_num" value="${user.univ_num }" ><br>                    
                  </div>
                </div>
                <div class="form-group">        
