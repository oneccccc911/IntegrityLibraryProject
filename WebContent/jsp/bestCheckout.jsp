		...
		<br><br><br><br><br>
					<div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Top5_total</h3>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <c:forEach items="${booklist }" var="book">
                                            <tr>
                             <%-- <td><a href="empDetail?empno=${book.empno }">${book.book_name }</a></td> --%>
                                                <td>${book.rownum }</td>
                                                <td>${book.book_name }</td>
                                                <td>${book.book_author }</td>
                                                <td><fmt:formatDate value="${book.book_year }" pattern="yyyy" /></td>
                                                <td>${book.book_pub }</td>
                                            </tr>                                      
                                            </c:forEach>
                                        </tbody>
			...
			<!--  -->
			         <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Top10_weekly</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                   ...
                   <%-- <td><a href="empDetail?empno=${book.empno }">${book.book_name }</a></td> --%>
                                ...
                                <!-- <div class="text-right">
                                 ...
                                 <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Top10_monthly</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${booklist2 }" var="book">
                                            <tr>
           <%-- <td><a href="empDetail?empno=${book.empno }">${book.book_name }</a></td> --%>
                                                <td>${book.rownum }</td>
                                                <td>${book.book_name }</td>
