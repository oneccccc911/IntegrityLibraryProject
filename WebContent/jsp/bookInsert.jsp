         ...
         <div class="panel panel-default">
            <div class="panel-heading">
               <h3 class="panel-title">
                  <i class="fa fa-money fa-fw"></i> 신간 등록
               </h3>
            </div>
               ...
               <div class="table-responsive">
                  <form action="bookInsert" method="post">
                     <table class="table table-bordered table-hover table-striped">
                        <thead>
                           <tr>
                              <td colspan="2">도서 등록</td>
                           </tr>
                           <tr>
                              <td>도서ID</td>
                              <td><input type="text" name="book_ID"
                                 autofocus="autofocus" required="required"
                                 placeholder="필수 입력 사항. Bxxx"></td>
                           </tr>
                           <tr>
                              <td>제목</td>
                              <td><input type="text" name="book_name"
                                 required="required" placeholder="필수 입력 사항"></td>
                           </tr>
                           <tr>
                              <td>저자</td>
                           ...
                           <tr>
                              <td>발간년도</td>
                              <td><input type="date" name="book_year"></td>
                           </tr>
                           <tr>
                              <td>페이지수</td>
                           ...
                           <tr>
                           	  <td>도서관ID</td>
                              <td><select name="lib_name">
                                    <c:forEach items="${liblist}" var="Library">
                                       <option value="${Library.lib_ID }">${Library.lib_name }</option>
                                    </c:forEach>
                              </select></td>
                           </tr>
                           <tr>
