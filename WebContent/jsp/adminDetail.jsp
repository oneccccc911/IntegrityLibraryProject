	...
	<div id="wrapper">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				...
				<li><a href="libList"><i class="fa fa-fw fa-desktop"></i>
						도서관 안내 </a></li>
				<li>
								...
								<thead>
									<tr>
										...
										<td><input type="text" name="book_ID"
											value="${booklist.book_ID}" size="30"></td>
									</tr>
									<tr>
										<td>이름</td>
										<td><input type="text" name="book_name"
											value="${booklist.book_name}" size="30"></td>
									</tr>
									<tr>
										<td>저자</td>
										<td><input type="text" name="book_author"
											value="${booklist.book_author}" size="30"></td>
									</tr>
									<tr>
										<td>분류</td>
										<td><input type="text" name="book_cate"
											value="${booklist.book_cate}" size="30"></td>
									</tr>
									<tr>
										<td>발간년도</td>
										<td><input type="text" name="book_year"
											value="${booklist.book_year}" size="30"></td>
									</tr>
									<tr>
										<td>페이지 수</td>
										<td><input type="text" name="book_page"
											value="${booklist.book_page}" size="30"></td>
									</tr>
									<tr>
										<td>출판사</td>
										<td><input type="text" name="book_pub"
											value="${booklist.book_pub}" size="30"></td>
									</tr>
									<tr>
										<td>도서관 이름</td>
										<td><input type="text" name="lib_name"
											value="${booklist.lib_name}" size="30"></td>
									</tr>
									<tr>
										<td>사본 번호</td>
										<td><input type="text" name="copy_ID"
											value="${booklist.copy_ID}" size="30"></td>
									</tr>
									<tr>
										<td colspan="9"><input type="submit" value="수정하기"></td>
									</tr>
								</thead>
