 ...
 <!-- 추가 -->
  	<script>
  	 window.onload=function(){
  		 ...
  		 if(msg==4) alert("아이디 또는 비밀번호가 올바르지 않습니다.");
  	 }
...
<!-- 마페&manageuser /끝 -->
		...
		<br><br><br>
		 ...
		 <div class="container" style="padding: 80px 10px 260px 10px">
		  <h2 style="font-size: 250%; padding-left: 1.5cm">로그인</h2><br><br><br><br><br><br>
